  ...
  return (
    <div>
      ...
      <section
        ...
        style={{ backgroundImage: "url('../images/writingImage.jpg')" }}
      ...
      >
        <div class="text-black text-center mx-auto">
          ...
          <a
            href="/note"
            class="bg-orange-400 text-white py-2 px-6 rounded-full font-bold text-lg hover:bg-orange-600"
          >
            Get Started
          </a>
        </div>
      ...
      <section class="bg-orange-400	 text-white p-8">
        <div class="max-w-2xl mx-auto text-center">
          ...
          <a
            href="/note"
            class="bg-white text-orange-500 py-2 px-6 rounded-full font-bold text-lg hover:bg-orange-100 hover:text-orange-700"
          >
            Write
          </a>
        </div>
